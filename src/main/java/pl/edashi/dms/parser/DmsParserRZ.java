...
public class DmsParserRZ implements DmsParser{
	private final AppLogger log = new AppLogger("Parser RZ");
    public DmsParsedDocument parse(Document doc, String fileName) {
        ...
        try {
            ...
            for (int i = 0; i < docList.getLength(); i++) {
                ...
                if ("02".equals(docEl.getAttribute("typ"))) {
                    ...
                    if (daneEl != null && daneEl.hasAttribute("kasa")) {
                        ...
                        //log.info(String.format("Parser RZ kasa='%s ' oddzial='%s '  ", kasa, oddzial));
            ...
            log.warn("Parser RZ: nie udało się odczytać kart: " + ex.getMessage());
        }
