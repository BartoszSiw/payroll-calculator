...
public class DmsParserRO implements DmsParser{
	private final AppLogger log = new AppLogger("Parser RO");
    public DmsParsedDocument parse(Document doc, String fileName) {
        ...
        try {
            ...
            log.warn("Parser RO: nie udało się odczytać kasa: " + ex.getMessage());
        }
        ...
        for (int i = 0; i < list.getLength(); i++) {
            ...
            if ("02".equals(el.getAttribute("typ"))) {
                ...
                out.setAdditionalDescription("RO Description" + fullNumber);
                out.setDocumentType("RO");
