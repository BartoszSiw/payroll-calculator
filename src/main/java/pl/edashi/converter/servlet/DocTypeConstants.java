...
public final class DocTypeConstants {
    ...
    public static final Set<String> DK_TYPES = Set.of("KO","KZ","DK","RO","RZ","RD","DWP","DWW");
    ...
    public static final Set<String> CARD_REPORT_DB_DEFERRED_TYPES = Set.of("RO", "RZ", "RD", "DWP", "DWW");
}
